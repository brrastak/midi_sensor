...
U 1 1 6129FF9C
P 2350 3000
F 0 "JP1" H 2350 3113 50  0000 C CNN
F 1 "SolderJumper_2_Open" H 2350 3114 50  0001 C CNN
...
U 1 1 612A1357
P 3900 4200
F 0 "Q1" H 4091 4246 50  0000 L CNN
F 1 "BCX54" H 4091 4155 50  0000 L CNN
F 2 "Package_TO_SOT_SMD:SOT-89-3" H 4100 4125 50  0001 L CIN
F 3 "http://cache.nxp.com/documents/data_sheet/BCP56_BCX56_BC56PA.pdf?pspll=1" H 3900 4200 50  0001 L CNN
	1    3900 4200
	1    0    0    -1  
$EndComp
$Comp
...
U 3 1 612A3ADB
P 4100 5700
F 0 "U2" H 4058 5746 50  0000 L CNN
F 1 "LM393" H 4058 5655 50  0000 L CNN
F 2 "" H 4100 5700 50  0001 C CNN
F 3 "http://www.ti.com/lit/ds/symlink/lm393-n.pdf" H 4100 5700 50  0001 C CNN
	3    4100 5700
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 6129EF60
P 1300 4800
F 0 "J1" H 1200 5450 50  0000 L CNN
F 1 "Conn_01x12" H 1380 4701 50  0001 L CNN
...
U 1 1 612BB648
P 2350 3250
F 0 "JP2" H 2350 3363 50  0000 C CNN
F 1 "SolderJumper_2_Open" H 2350 3364 50  0001 C CNN
...
U 1 1 612BB8FE
P 2350 3500
F 0 "JP3" H 2350 3613 50  0000 C CNN
F 1 "SolderJumper_2_Open" H 2350 3614 50  0001 C CNN
...
U 1 1 612BBB59
P 2350 3750
F 0 "JP4" H 2350 3863 50  0000 C CNN
...
U 1 1 612BBDC0
P 2350 4000
F 0 "JP5" H 2350 4113 50  0000 C CNN
...
U 1 1 612BC042
P 2350 4250
F 0 "JP6" H 2350 4363 50  0000 C CNN
...
U 1 1 612F4A52
P 4000 6000
F 0 "#PWR02" H 4000 5750 50  0001 C CNN
...
F 1 "4.7 1% 2010" H 4070 4705 50  0000 L CNN
...
U 1 1 6138D214
P 2750 6000
F 0 "TP2" H 2800 6200 50  0000 L CNN
F 1 "TestPoint" H 2808 6027 50  0001 L CNN
...
F 1 "1.1k" H 6570 5205 50  0000 L CNN
...
F 1 "1.1k 1%" H 8070 2705 50  0000 L CNN
...
F 1 "1.1 1%" H 8070 3305 50  0000 L CNN
...
F 1 "3.3k 1%" H 9570 2705 50  0000 L CNN
...
F 1 "1.1 1%" H 9570 3305 50  0000 L CNN
...
F 1 "0.1" H 3615 5655 50  0000 L CNN
...
U 1 1 6146A51C
P 8800 3350
F 0 "R9" H 8870 3396 50  0000 L CNN
F 1 "13k" H 8870 3305 50  0000 L CNN
...
U 1 1 6146A964
P 10300 3350
F 0 "R12" H 10370 3396 50  0000 L CNN
F 1 "13k" H 10370 3305 50  0000 L CNN
...
U 1 1 615147CE
P 3000 5400
F 0 "#FLG01" H 3000 5475 50  0001 C CNN
F 1 "PWR_FLAG" H 3000 5573 50  0000 C CNN
...
U 1 1 61514E96
P 3000 6000
F 0 "#FLG02" H 3000 6075 50  0001 C CNN
F 1 "PWR_FLAG" H 3050 5900 50  0000 C CNN
...
U 1 1 6153BF55
P 2500 5700
F 0 "C1" H 2615 5746 50  0000 L CNN
F 1 "1u" H 2615 5655 50  0000 L CNN
...
U 1 1 616FFA59
P 8800 4100
F 0 "D1" V 8754 4188 50  0000 L CNN
F 1 "BAT54C" V 8845 4188 50  0000 L CNN
F 2 "Package_TO_SOT_SMD:SOT-23" H 8875 4225 50  0001 L CNN
F 3 "http://www.diodes.com/_files/datasheets/ds11005.pdf" H 8720 4100 50  0001 C CNN
	1    8800 4100
	0    1    1    0   
$EndComp
Wire Wire Line
...
U 1 1 6170CEAA
P 10300 4100
F 0 "D2" V 10254 4188 50  0000 L CNN
F 1 "BAT54C" V 10345 4188 50  0000 L CNN
F 2 "Package_TO_SOT_SMD:SOT-23" H 10375 4225 50  0001 L CNN
F 3 "http://www.diodes.com/_files/datasheets/ds11005.pdf" H 10220 4100 50  0001 C CNN
	1    10300 4100
	0    1    1    0   
$EndComp
Wire Wire Line
